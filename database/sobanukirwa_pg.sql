-- ============================================================
-- Sobanukirwa - Complete PostgreSQL Database Schema
-- Version 1.0
-- ============================================================
...
INSERT INTO categories (name, name_ar, name_en, slug, sort_order)
VALUES
...
INSERT INTO artists (name, name_ar, name_en, image_url)
VALUES
...
INSERT INTO quran_surahs (surah_number, name, name_arabic, ayahs_count, revelation_type, audio_url)
VALUES
...
INSERT INTO adhkar (arabic_text, transliteration, translation_rw, translation_en, count_target, category, sort_order)
VALUES
...
CREATE INDEX IF NOT EXISTS idx_quran_surah_number ON quran_surahs(surah_number);
