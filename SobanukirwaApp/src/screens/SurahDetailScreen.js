    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        <View style={styles.heroSection}>
          <Text style={styles.heroSurahNum}>
            {t('Sura', 'Surah', 'سورة')} {surah.number}
          </Text>

          <Text style={styles.heroArabicName}>
            {surahData.name}
          </Text>

          <Text style={styles.heroBismillah}>
          ...
          <View style={styles.heroBadges}>
            <View style={[styles.badge, isMeccan ? styles.badgeMeccan : styles.badgeMedinan]}>
              {isMeccan ? <Flame size={12} color={C.error} /> : <Leaf size={12} color={C.success} />}
              <Text style={[styles.badgeText, { color: isMeccan ? C.error : C.success }]}>{surahData.revelationType}</Text>
            </View>
            <View style={styles.badge}>
              <FileText size={12} color={C.primary} />
              <Text style={[styles.badgeText, { color: C.primary }]}>{totalAyahs} {t('ayahs', 'ayahs', 'آية')}</Text>
            </View>
            <View style={styles.badge}>
        ...
        <View style={styles.playerCard}>
          <View style={styles.playerTop}>
            <Animated.View style={[styles.playerDisc, {
              borderColor: playing ? C.secondary : C.border,
              backgroundColor: playing ? '#F0FDFA' : '#F9FAFB',
              transform: [{ rotate: spin }]
            }]}>
              <BookOpen size={28} color={C.primary} />
            </Animated.View>
          ...
          <View style={styles.playerControls}>
            ...
            <TouchableOpacity style={styles.playBtn} onPress={togglePlayPause}>
              {loading ? (
                ...
                playing ? <Pause size={28} color="#FFFFFF" /> : <Play size={28} color="#FFFFFF" style={{ marginLeft: 3 }} />
              )}
            </TouchableOpacity>
        ...
        <View style={styles.infoRow}>
          <View style={[styles.infoItem, { borderRightWidth: 1, borderRightColor: C.border }]}>
            <User size={18} color={C.primary} />
            <Text style={styles.infoLabel}>{t('Mukuru', 'Reciter', 'القارئ')}</Text>
            <Text style={styles.infoValue}>Ahmed Al-Ajmi</Text>
          </View>
          <View style={styles.infoItem}>
            <Mic size={18} color={C.primary} />
            <Text style={styles.infoLabel}>{t('Igitangiro', 'Starts with', 'يبدأ بـ')}</Text>
            <Text style={styles.infoValue}>بِسْمِ</Text>
          </View>
        </View>
      </ScrollView>
    </SafeAreaView>
