...
const FALLBACK = {
  ...
  adhkar: [
    ...
    { arabic: "الْحَمْدُ لِلَّهِ", transliteration: "Alhamdulillah", translationRw: "Ishimwe n'ikuzo ni ibya Allah", translationEn: "Praise be to Allah", count: 33, category: "general", audioFile: "audio/Subhanallah Alhamdulillah Wa La ilaha IlAllah (Dhikr).m4a" },
    ...
    { arabic: "لَا إِلَٰهَ إِلَّا اللَّهُ", transliteration: "La ilaha illallah", translationRw: "Nta mana iri isobok uretse Allah", translationEn: "There is no god but Allah", count: 10, category: "general", audioFile: "audio/Subhanallah Alhamdulillah Wa La ilaha IlAllah (Dhikr).m4a" },
    ...
    { arabic: "لَا إِلَٰهَ إِلَّا اللَّهُ وَحْدَهُ لَا شَرِيكَ لَهُ", transliteration: "La ilaha illallahu wahdahu la sharika lah", translationRw: "Nta mana iri isobok uretse Allah wenyine", translationEn: "There is no god but Allah alone", count: 10, category: "morning", audioFile: "audio/Subhanallah Alhamdulillah Wa La ilaha IlAllah (Dhikr).m4a" },
    ...
    { arabic: "بِسْمِ اللَّهِ الرَّحْمَٰنِ الرَّحِيمِ", transliteration: "Bismillahir Rahmanir Rahim", translationRw: "Mu izina rya Allah, Nyirimpuhwe, Nyirimbabazi", translationEn: "In the name of Allah, the Most Gracious, the Most Merciful", count: 7, category: "general", audioFile: "audio/Subhanallah Alhamdulillah Wa La ilaha IlAllah (Dhikr).m4a" },
    { arabic: "اللَّهُمَّ صَلِّ عَلَىٰ مُحَمَّدٍ", transliteration: "Allahumma salli ala Muhammad", translationRw: "Allah uheshe imigisha intumwa Muhamad", translationEn: "O Allah, send blessings upon Muhammad", count: 10, category: "general", audioFile: "audio/Allahuma Salli Ala.m4a" },
